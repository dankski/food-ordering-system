...
public class PaymentRequestMessageListenerImpl implements PaymentRequestMessageListener {
    ...
    public PaymentRequestMessageListenerImpl(PaymentRequestHelper paymentRequestHelper,
        ...
        this.paymentCancelledMessagePublisher = cancelledMessagePublisher;
    ...
    private void fireEvent(PaymentEvent paymentEvent) {
        ...
        if (paymentEvent instanceof PaymentCompletedEvent) {
            ...
            paymentCancelledMessagePublisher.publish((PaymentCanceledEvent) paymentEvent);
        } else if (paymentEvent instanceof PaymentFailedEvent) {
            paymentFailedMessagePublisher.publish((PaymentCanceledEvent) paymentEvent);
        }
    }
}
