        ...
        try {
            ...
            kafkaProducer.send(restaurantServiceConfigData.getRestaurantApprovalResponseTopicName(),
                    ...
                    kafkaMessageHelper.getKafkaCallback(restaurantServiceConfigData
                            ...
                            restaurantApprovalResponseAvroModel,
                            orderId,
                            "RestaurantRejectedResponseAvroModel"));
            log.info("RestaurantRejectedResponseAvroModel sent to kafka at: {}", System.nanoTime());
        } catch (Exception e) {
            log.error("Error while sending RestaurantRejectedResponseAvroModel message " +
