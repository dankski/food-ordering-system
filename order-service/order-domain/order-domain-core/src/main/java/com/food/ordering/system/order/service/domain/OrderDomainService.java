...
public interface OrderDomainService {
    ...
    OrderCreatedEvent validateAndInitiatedOrder(Order order, Restaurant restaurant, DomainEventPublisher<OrderCreatedEvent> orderCreatedEventDomainEventPublisher);
